...
{
protected:
	GLuint vertexShader, fragmentShader, geometryShader, computeShader, shader;
	const GLchar* vertex_shader_source;
	const GLchar* fragment_shader_source;
	GLchar* compute_shader_source;
	GLchar* geometry_shader_source;
	void LoadShader(const char *compute_path);
...
public:
	_Shader(const char *compute_path);
